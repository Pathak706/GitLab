            ...
            try {
                ...
                model.getLatestId()
                    ...
                    .then((user) => {
                        ...
                        toUpdate['pendingMiscellaneousExpenses'] = projectAttributes['pendingMiscellaneousExpenses'] || 0;
                        toUpdate['pendingMiscellaneousExpenses'] = toUpdate['pendingMiscellaneousExpenses'] + 1;
