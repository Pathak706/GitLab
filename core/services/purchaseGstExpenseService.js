            ...
            try {
                ...
                model.getLatestId()
                    ...
                    .then((user) => {
                        ...
                        toUpdate['pendingPurchaseGstExpenses'] = projectAttributes['pendingPurchaseGstExpenses'] || 0;
                        toUpdate['pendingPurchaseGstExpenses'] = toUpdate['pendingPurchaseGstExpenses'] + 1;
