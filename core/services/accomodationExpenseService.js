            ...
            try {
                ...
                model.getLatestId()
                    ...
                    .then((user) => {
                        ...
                        toUpdate['pendingAccomodationExpenses'] = projectAttributes['pendingAccomodationExpenses'] || 0;
                        toUpdate['pendingAccomodationExpenses'] = toUpdate['pendingAccomodationExpenses'] + 1;
